    ...
    <form action="{{ route('prestamos.action.editar', $prestamo->id) }}" method="POST">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <input type="checkbox" class="form-control" name="tiene_cable_poder" id="tiene_cable_poder" {{$prestamo->tiene_cable_poder ? 'checked' : ''}}>
            </div>
            <div class="form-group">
                <label for="tiene_cable_video">Tiene Cable de Video</label>
                <input type="checkbox" class="form-control" name="tiene_cable_video" id="tiene_cable_video" {{$prestamo->tiene_cable_video ? 'checked' : ''}}>
            </div>
            <div class="form-group">
                <label for="tiene_estuche">Tiene Estuche</label>
                <input type="checkbox" class="form-control" name="tiene_estuche" id="tiene_estuche" {{$prestamo->tiene_estuche ? 'checked' : ''}}>
            </div>
            <div class="form-group">
